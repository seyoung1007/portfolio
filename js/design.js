const works = [
  {
    title: "Storm Striker MPSHOP",
    category: "UI/UX · Client Work",
    period: "2026.08",
    tools: "Figma · Photoshop · Illustrator",

    description:
      "Storm Striker MP 서비스를 대상으로 기존 기능과 콘텐츠를 분석하고, 사용자 참여를 중심으로 IA와 UI/UX를 재설계한 Redesign Proposal입니다.",

    // 프로젝트 목록에서 보여줄 대표 이미지
    image: "assets/images/stormstriker/after/home.png",

    // 기존 상세 이미지
    detail: "assets/images/stormstriker/after/home.png",

    // 케이스 스터디 AFTER 이미지
    after: [
      "assets/images/stormstriker/after/home.png",
      "assets/images/stormstriker/after/play.png",
      "assets/images/stormstriker/after/my-page.png",
      "assets/images/stormstriker/after/friend-guide.png",
      "assets/images/stormstriker/after/slot-machine.png"
    ],

    // 케이스 스터디 BEFORE 이미지
    before: [
      "assets/images/stormstriker/before/home-before.png",
      "assets/images/stormstriker/before/reward-storage-01.png",
      "assets/images/stormstriker/before/storm-dive-01.png",
      "assets/images/stormstriker/before/storm-dive-02.png",
      "assets/images/stormstriker/before/friend-guide-01.png"
    ],

    caseStudy: true,

    intent:
      "정보가 분산되어 있고 핵심 참여 동선이 약했던 기존 구조를 재분류해, 사용자가 보상과 뽑기 콘텐츠를 발견하고 자연스럽게 참여하도록 서비스 흐름을 재설계함.",

    learned:
      "개별 화면을 만드는 것보다 IA와 사용자 행동 흐름을 먼저 정의하는 것이 UI 완성도와 일관성을 높인다는 것을 실무 프로젝트에서 경험함.",

    thoughts:
      "실제 서비스에 적용되지 않은 제안안이지만, 클라이언트 용역 프로젝트에서 문제를 정의하고 UX 방향과 화면으로 연결하는 과정을 경험함."
  },
...

  {
    ...
    tools: "Figma",
    description:
      "User Flow를 먼저 설계한 뒤 화면을 구성한 앱 UI입니다.",
    ...
    thoughts:
      "좋은 UI는 화면이 아니라 흐름에서 시작된다는 걸 체감함."
  },
...

  {
    ...
    tools: "Figma",
    description:
      "'혼밥' 상황에 맞춰 메뉴 선택을 단순화한 앱 UI입니다.",
    image: "assets/images/design/앱디자인3.png",
    detail: "assets/images/design/앱디자인3.png",
    url: "https://www.figma.com/design/TJeVxZGO89fXJdvGT8XBFb/honbab?node-id=0-1&t=f44DTUhWSlwmmHJ1-1",
...
document.querySelectorAll(".card").forEach((card, index) => {
  card.onclick = () => {
    ...
    /*
     * Storm Striker는 케이스 스터디이므로
     * AFTER 5장 + BEFORE 5장을 표시
     */
    if (item.caseStudy && item.after && item.before) {
      imageBox.innerHTML = `
        <div class="case-study-images">

          <section class="case-section">
            <div class="case-section-title">AFTER</div>
            <div class="case-image-list">
              ${item.after
                .map(
                  (src) => `
                    <img src="${src}" alt="${item.title} After">
                  `
                )
                .join("")}
            </div>
          ...
          <section class="case-section">
            <div class="case-section-title">BEFORE</div>
            <div class="case-image-list">
              ${item.before
                .map(
                  (src) => `
                    <img src="${src}" alt="${item.title} Before">
                  `
                )
                .join("")}
            </div>

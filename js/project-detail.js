...
const projectDetails = {
  ...
  gameMarketing: {
    ...
    meta: "외부 프로젝트 · 2026.07 ~ 2026.08 · SNS Marketing, Video Editing",

    intent:
      "게임의 북미 런칭을 위한 홍보 콘텐츠 제작 및 SNS 채널 운영",

    learned:
      "홍보 영상 제작부터 X(SNS) 게시, 조회수 및 유저 반응 확인, 리트윗·좋아요·댓글 등 커뮤니티 관리까지 콘텐츠 운영의 전체적인 흐름을 경험함.",

    thoughts:
      "콘텐츠를 제작하는 것에서 끝나는 것이 아니라 게시 이후의 유저 반응과 콘텐츠 성과를 함께 확인하는 것이 중요하다는 것을 경험함."
  },
};
